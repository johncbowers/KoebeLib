...
class DiskS2(val a: Double, val b: Double, val c: Double, val d: Double) {
    ...
    val radiusS2: Double by lazy { Math.asin(radiusE3) } // TODO This only works if <pi/2, needs to be fixed otherwise.
    ...
    fun toDiskOP2() : DiskOP2 = DiskOP2((a - d) * 0.5, c, b, -(a + d) * 0.5)
